...
public class WalletService {
    ...
    /** Lấy ví của người đang đăng nhập (SecurityContextHolder), tương tự TransactionService dùng current user làm buyer. */
    public WalletResponse viewWallet() {
        var context = SecurityContextHolder.getContext();
        String name = context.getAuthentication().getName();
    ...
    /** Nạp tiền vào ví của người đang đăng nhập (SecurityContextHolder). */
    @Transactional
    ...
    /** Rút tiền từ ví của người đang đăng nhập (SecurityContextHolder). */
    @Transactional
